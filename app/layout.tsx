            ...
            <div className="max-w-[1400px] mx-auto h-full px-4 flex items-center justify-between gap-4">
              ...
              <div className="flex-1 max-w-3xl flex items-center gap-2">
                <div className="relative group">
                  <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl px-4 py-2.5 text-xs font-black text-zinc-500 dark:text-zinc-400 cursor-pointer hover:bg-zinc-200 dark:hover:bg-zinc-800 hover:text-zinc-900 dark:hover:text-white transition-all flex items-center gap-2 min-w-[80px] justify-between">
                    <span>베스트</span>
                    <span className="text-[8px] text-zinc-400 dark:text-zinc-600 group-hover:rotate-180 transition-transform duration-200">▼</span>
                  </div>
                  <div className="absolute top-full left-0 mt-2 w-32 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-2xl py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 transform origin-top scale-95 group-hover:scale-100">
                    <div className="px-4 py-2 text-xs font-bold text-zinc-500 dark:text-zinc-400 hover:bg-blue-600 hover:text-white cursor-pointer">베스트</div>
                    <div className="px-4 py-2 text-xs font-bold text-zinc-500 dark:text-zinc-400 hover:bg-blue-600 hover:text-white cursor-pointer">공지</div>
                    <div className="px-4 py-2 text-xs font-bold text-zinc-500 dark:text-zinc-400 hover:bg-blue-600 hover:text-white cursor-pointer">문의</div>
                    <div className="px-4 py-2 text-xs font-bold text-zinc-500 dark:text-zinc-400 hover:bg-blue-600 hover:text-white cursor-pointer">유머</div>
                  </div>
                </div>
